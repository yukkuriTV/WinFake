...
Windows 10上で実行したアプリケーションに対してWindows 11 25H2であると返すプログラム。このプロジェクトは姉妹プロジェクトとして予定されているWOW8.1及びWOW10の前身となる試験的なプログラムです。WOW7のリリースが困難であるため、このプロジェクトのWindows 7版は開発を終了しました。

※姉妹プロジェクトとしてWOW8.1（Windows on Windows 8.1）とWOW10（Windows on Windows 10）を立ち上げる予定です。この2つのプロジェクトでは、本格的な互換レイヤーが提供できるよう、テストしています。これらのプロジェクトがGithub上に公開されたら、WinFakeの新規開発を停止したいと考えています。
【使い方】
...
※Windows 7のサポートは終了しました。これは姉妹プロジェクトとして予定されているWOW8.1・WOW10に合わせるための措置であり、Version 3.1まではWindows 7での実行が可能です。
